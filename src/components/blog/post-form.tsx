...
export function PostForm(props:PostFormProps){
        ...
        const form = useForm<PostFormValues>({
            ...
            defaultValues: props.mode=="edit" ? {title:props.post.title, slug:props.post.slug, content: props.post.content}
            :{title:"", slug:"", content:""}
        })

        const onSubmit = form.handleSubmit((values)=>{
            startTransition(async()=>{
                const result = props.mode ==="create" ? await createPost(values): await updatePost(values)
